          ...
          for (const snap of uniSnapshots) {
            rows.push({
              ...
              onchainDataJson: JSON.stringify({
                ...
                amount0Raw: snap.amount0Raw,
                amount1Raw: snap.amount1Raw,
                amount0Usd: snap.amount0Usd,
                amount1Usd: snap.amount1Usd,
                feesOwed0Raw: snap.feesOwed0Raw,
                feesOwed1Raw: snap.feesOwed1Raw,
                feesOwed0Usd: snap.feesOwed0Usd,
                feesOwed1Usd: snap.feesOwed1Usd
              }),
